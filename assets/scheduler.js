...
var scheduler_production_min = createCommonjsModule(function (module, exports) {
  ...
  function H(a, b) {
    ...
    a: for (;;) {
      var d = (c - 1) >>> 1,
        e = a[d];
      if (e !== void 0 && 0 < I(e, b)) (a[d] = b), (a[c] = e), (c = d);
      else break a;
    }
  }
  function J(a) {
        ...
        a: for (var d = 0, e = a.length; d < e; ) {
          ...
          if (n !== void 0 && 0 > I(n, c))
            r !== void 0 && 0 > I(r, n)
              ? ((a[d] = r), (a[v] = c), (d = v))
              : ((a[d] = n), (a[m] = c), (d = m));
          else if (r !== void 0 && 0 > I(r, c)) (a[d] = r), (a[v] = c), (d = v);
          else break a;
        }
      }
      return b;
  ...
  exports.unstable_scheduleCallback = function (a, b, c) {
    ...
    c > d
      ? ((a.sortIndex = c),
        H(M, a),
        J(L) === null && a === J(M) && (S ? h() : (S = true), g(U, c - d)))
      : ((a.sortIndex = e), H(L, a), R || Q || ((R = true), f(V)));
    return a;
  };
