/* esm.sh - esbuild bundle(buffer@6.0.3) es2022 production */
...
var b = (i, r) => () => (r || i((r = { exports: {} }).exports, r), r.exports),
  Ar = (i, r) => {
    for (var t in r) $(i, t, { get: r[t], enumerable: !0 });
  },
  D = (i, r, t, n) => {
    if ((r && typeof r == "object") || typeof r == "function")
      for (let e of mr(r))
        !Fr.call(i, e) &&
          ...
          $(i, e, {
            get: () => r[e],
            enumerable: !(n = gr(r, e)) || n.enumerable,
          });
    return i;
  },
  I = (i, r, t) => (D(i, r, "default"), t && D(t, r, "default")),
  J = (i, r, t) => (
    (t = i != null ? dr(Ir(i)) : {}),
    D(
      r || !i || !i.__esModule
        ? $(t, "default", { value: i, enumerable: !0 })
        : t,
      i
    )
  );
var Q = b((L) => {
  ...
  function Cr(i) {
    ...
    return (
      e === 2 &&
        ((r = (w[i.charCodeAt(c)] << 2) | (w[i.charCodeAt(c + 1)] >> 4)),
        (o[u++] = r & 255)),
      e === 1 &&
        ((r =
          (w[i.charCodeAt(c)] << 10) |
  ...
  function Lr(i) {
    for (
      var r, t = i.length, n = t % 3, e = [], o = 16383, u = 0, f = t - n;
      u < f;
      u += o
    )
...
var v = b((O) => {
  O.read = function (i, r, t, n, e) {
    var o,
      ...
      x = i[r + p];
    for (
      p += U, o = x & ((1 << -s) - 1), x >>= -s, s += f;
      s > 0;
      o = o * 256 + i[r + p], p += U, s -= 8
    );
    for (
      u = o & ((1 << -s) - 1), o >>= -s, s += n;
      s > 0;
      u = u * 256 + i[r + p], p += U, s -= 8
    );
    if (o === 0) o = 1 - l;
    else {
      ...
      r = Math.abs(r),
        isNaN(r) || r === 1 / 0
          ...
          : ((u = Math.floor(Math.log(r) / Math.LN2)),
            ...
            u + p >= 1 ? (r += U / c) : (r += U * Math.pow(2, 1 - p)),
            r * c >= 2 && (u++, (c /= 2)),
            u + p >= s
              ? ((f = 0), (u = s))
              : u + p >= 1
...
var z = b((_) => {
  ...
  h.prototype.readUint16LE = h.prototype.readUInt16LE = function (r, t) {
    return (
      (r = r >>> 0), t || a(r, 2, this.length), this[r] | (this[r + 1] << 8)
    );
  };
  h.prototype.readUint16BE = h.prototype.readUInt16BE = function (r, t) {
    return (
      (r = r >>> 0), t || a(r, 2, this.length), (this[r] << 8) | this[r + 1]
    );
  };
  ...
  h.prototype.readBigInt64LE = g(function (r) {
    ...
    (t === void 0 || n === void 0) && S(r, this.length - 8);
    let e =
      this[r + 4] + this[r + 5] * 2 ** 8 + this[r + 6] * 2 ** 16 + (n << 24);
    return (
      (BigInt(e) << BigInt(32)) +
  ...
  h.prototype.readFloatLE = function (r, t) {
    return (r = r >>> 0), t || a(r, 4, this.length), R.read(this, r, !0, 23, 4);
  };
  h.prototype.readFloatBE = function (r, t) {
    return (r = r >>> 0), t || a(r, 4, this.length), R.read(this, r, !1, 23, 4);
  };
  h.prototype.readDoubleLE = function (r, t) {
    return (r = r >>> 0), t || a(r, 8, this.length), R.read(this, r, !0, 52, 8);
  };
  h.prototype.readDoubleBE = function (r, t) {
    return (r = r >>> 0), t || a(r, 8, this.length), R.read(this, r, !1, 52, 8);
  };
  ...
  function lr(i, r, t, n, e) {
    return (
      (r = +r),
      (t = t >>> 0),
      e || sr(i, r, t, 4, 34028234663852886e22, -34028234663852886e22),
      R.write(i, r, t, n, 23, 4),
      t + 4
    );
  }
  ...
  function ar(i, r, t, n, e) {
    return (
      (r = +r),
      (t = t >>> 0),
      e || sr(i, r, t, 8, 17976931348623157e292, -17976931348623157e292),
      R.write(i, r, t, n, 52, 8),
      t + 8
    );
  }
  ...
  function Kr(i, r, t) {
    C(r, "offset"),
      (i[r] === void 0 || i[r + t] === void 0) && S(r, i.length - (t + 1));
  }
      ...
      throw (
        (o > 3
          ? r === 0 || r === BigInt(0)
            ...
            : (f = `>= -(2${u} ** ${(o + 1) * 8 - 1}${u}) and < 2 ** ${
                (o + 1) * 8 - 1
              }${u}`)
          : (f = `>= ${r}${u} and <= ${t}${u}`),
        new T.ERR_OUT_OF_RANGE("value", f, i))
      );
    }
    Kr(n, e, o);
  }
  ...
  function S(i, r, t) {
    throw Math.floor(i) !== i
      ? (C(i, t), new T.ERR_OUT_OF_RANGE(t || "offset", "an integer", i))
      : r < 0
      ? new T.ERR_BUFFER_OUT_OF_BOUNDS()
      : new T.ERR_OUT_OF_RANGE(t || "offset", `>= ${t ? 1 : 0} and <= ${r}`, i);
  }
