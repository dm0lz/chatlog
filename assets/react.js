import l from "./object-assign.js";
...
var react_production_min = createCommonjsModule(function (module, exports) {
  ...
  var G = { current: null },
    ...
    I = { key: true, ref: true, __self: true, __source: true };
  function J(a, b, c) {
    var e,
      d = {},
      k = null,
    ...
    if (a && a.defaultProps)
      for (e in ((g = a.defaultProps), g)) d[e] === void 0 && (d[e] = g[e]);
    return {
      $$typeof: n,
      type: a,
      key: k,
  ...
  exports.cloneElement = function (a, b, c) {
    ...
    if (b != null) {
      ...
      for (f in b)
        H.call(b, f) &&
          !I.hasOwnProperty(f) &&
          (e[f] = b[f] === void 0 && g !== void 0 ? g[f] : b[f]);
    }
